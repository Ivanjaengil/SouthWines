...
<body>
    ...
    <div class="video-background">
        <video autoplay muted loop>
            <source src="{{ asset('videos/homevideo.mp4') }}" type="video/mp4"> <!-- Cambia el nombre del archivo si es necesario -->
            ...
            <div class="container">
                <div class="courses-content">
                    <div class="courses-text">
                        ...
                        <a href="{{ route('cursos') }}" class="courses-btn">Ver Cursos</a>
                    </div>
                    <div class="courses-image">
                        <img src="{{ asset('img/cursos.jpg') }}" alt="Nuestros Cursos">
                    </div>
                </div>
            </div>
        </section>

    ...
    <div class="header__main">
        <div class="header__container">
            <div class="header__logo">
                <img src="{{ asset('img/Logo.png') }}?v=1.1" alt="South Wines Logo">
            </div>
            ...
            <nav class="header__nav">
                <ul class="header__menu">
                    ...
                    <li class="header__menu-item">
                        <a href="{{ route('cursos') }}" class="header__link">Cursos</a>
                    </li>
                    <li class="header__menu-item">
                        <a href="{{ route('sobre-nosotros') }}" class="header__link">Sobre nosotros</a>
                    </li>
                </ul>
            </nav>  
            ...
            <div class="header__actions">
                @auth
                    <div class="user-profile">
                        <div class="user-profile__content">
                            <a href="#" id="view-photo" class="user-profile__photo-link">
                                @if(Auth::user()->photo)
                                    <img src="{{ asset('storage/' . Auth::user()->photo) }}" alt="Foto de perfil" class="user-profile__photo">
                                @else
                                    <img src="{{ asset('path/to/default/image.jpg') }}" alt="Foto de perfil por defecto" class="user-profile__photo">
                                @endif
                            </a>
                    ...
                    <a href="{{ route('panel-administrador') }}" class="header__button" title="Panel de Control">
...
@auth
    ...
    <div class="modal" id="photo-modal">
        <div class="modal-content">
            ...
            @else
                <img src="{{ asset('path/to/default/image.jpg') }}" alt="Foto de perfil por defecto">
            @endif
        </div>
    </div>
@endauth

    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="register-link">
                <span>¿Ya tienes una cuenta? <a href="<?php echo e(route('login')); ?>" class="header__link">Iniciar Sesión</a></span>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel\southwines\resources\views/auth/register.blade.php ENDPATH**/ ?>
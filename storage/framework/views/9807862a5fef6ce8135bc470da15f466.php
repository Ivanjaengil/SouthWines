                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table admin-table">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $usuariosPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendiente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($pendiente->id); ?></td>
                                            <td><?php echo e($pendiente->name); ?></td>
                                            <td><?php echo e($pendiente->email); ?></td>
                                            <td><span class="badge badge-warning">Pendiente</span></td>
                                            <td>
                                                <form action="<?php echo e(route('estudiante.aprobar', $pendiente->id)); ?>" method="POST" style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <?php if($estudiantes->count() > 0): ?>
                                            <?php $__currentLoopData = $estudiantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estudiante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($estudiante->phone ?? 'No disponible'); ?></td>
                                                    <td><span class="badge badge-success"><?php echo e($estudiante->status); ?></span></td>
                                                    <td class="actions">
                                                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#editarEstudianteModal" 
                                                            data-id="<?php echo e($estudiante->id); ?>"
                                                            data-name="<?php echo e($estudiante->name); ?>"
                                                            data-email="<?php echo e($estudiante->email); ?>"
                                                            data-phone="<?php echo e($estudiante->phone); ?>">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <form class="delete-form" action="<?php echo e(route('estudiante.destroy', $estudiante->id)); ?>" method="POST" style="display: inline;">
                                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="nuevoEstudianteModal" tabindex="-1" role="dialog" aria-labelledby="nuevoEstudianteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="nuevoEstudianteForm" action="<?php echo e(route('estudiante.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        var newRow = '<tr>' +
                            ...
                            '<td class="actions">' +
                                '<button class="btn btn-sm btn-info" data-toggle="modal" data-target="#editarEstudianteModal" ' +
                                    ...
                                    '<i class="fas fa-edit"></i>' +
                                '</button>' +
                                '<form class="delete-form" action="<?php echo e(route("estudiante.destroy", ":id")); ?>" method="POST" style="display: inline;">'.replace(':id', response.estudiante.id) +
                                    '<?php echo csrf_field(); ?>' +
                                    '<?php echo method_field("DELETE"); ?>' +
                                    '<button type="submit" class="btn btn-sm btn-danger">' +
                                        '<i class="fas fa-trash"></i>' +
...
<?php /**PATH C:\xampp\htdocs\laravel\southwines\resources\views/panel-estudiantes.blade.php ENDPATH**/ ?>